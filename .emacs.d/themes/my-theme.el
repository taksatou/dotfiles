...
; '(hl-line ((t (:background "#293739"))))
 ...
 '(font-lock-string-face ((t (:foreground "#F6F904"))))

 ;; 特定キーワード
 '(font-lock-keyword-face ((t (:foreground "#F96672"))))

 ;; Boolean
 '(font-lock-constant-face((t (:foreground "#CE81EC"))))
 ...
 ;; コメント
 '(font-lock-comment-face ((t (:foreground "#94614D"))))
 ...
 ;; nXML-mode
 ;; タグ名
 '(nxml-element-local-name ((t (:foreground "#F96672"))))
 ;; 属性
